...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"0 auto","borderColor":"#ffc800","alignItems":"center","display":"flex","borderRadius":"0 0 12px 12px","flexWrap":"wrap","background":"#fbf9f3","borderWidth":"0 1px 1px 1px","width":"1200px","borderStyle":"solid","height":"auto","order":"2"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>小区位置</div>
        <el-input v-model="formSearch.xiaoquweizhi" placeholder="小区位置" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
	  ...
	  <el-button v-if="isAuth('xiaoquxinxi','新增')" :style='{"cursor":"pointer","border":"1px solid #db961f","padding":"0px 15px","boxShadow":"1px 1px 3px #f8a412","margin":"0px 10px 0 0","color":"#333","outline":"none","borderRadius":"4px","background":"linear-gradient(180deg, rgba(255,219,161,1) 0%, rgba(255,219,161,1) 51%, rgba(252,188,69,1) 51%, rgba(252,188,69,1) 100%)","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/xiaoquxinxiAdd')"><i v-if="true" :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","margin":"0","background":"none","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"border":"1px solid #ffc800","padding":"30px 20px 20px","boxShadow":"0px 0px 0px #ddd,inset 0px 0px 30px 0px #fbf5db","margin":"20px 0 0 0","borderRadius":"16px","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(100% - 2px)","justifyContent":"space-around","height":"auto"}'>
			<div :style='{"margin":"0 0 30px","borderRadius":"8px","background":"none","display":"inline-block","width":"32%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"cursor":"pointer","padding":"8px","borderColor":"#ffa100","objectFit":"cover","borderRadius":"20%","borderWidth":"3px","background":"#f5f6cb","display":"block","width":"100%","borderStyle":"dotted dashed solid double","height":"274px"}' v-if="item.xiaoqufengmian && item.xiaoqufengmian.substr(0,4)=='http'" :src="item.xiaoqufengmian" class="image" />
				<img :style='{"cursor":"pointer","padding":"8px","borderColor":"#ffa100","objectFit":"cover","borderRadius":"20%","borderWidth":"3px","background":"#f5f6cb","display":"block","width":"100%","borderStyle":"dotted dashed solid double","height":"274px"}' v-else :src="baseUrl + (item.xiaoqufengmian?item.xiaoqufengmian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"0 10px","boxShadow":"0px 2px 0px #f1e288","margin":"4px auto 0 auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"20% ","background":"#f6f6f6","width":"76%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.xiaoqumingcheng}}</div>
				<div :style='{"padding":"0 10px","boxShadow":"0px 2px 0px #f1e288","margin":"4px auto 0 auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"20% ","background":"#f6f6f6","width":"76%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.xiaoquweizhi}}</div>
			</div>
		</div>
	...
	<div class="hot" :style='{"margin":"20px 0 0","borderRadius":"8px 8px 0 0","top":"0","left":"101%","background":"none","width":"180px","position":"absolute","height":"auto","order":"5"}'>
	  ...
	  <div :style='{"border":"1px solid #ffc800","padding":"20px","boxShadow":"0px 0px 0px #eee,inset 0px 0px 30px 0px #fbf5db","borderRadius":"0 0 8px 8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
	    <div v-for="item in hotList" :key="item" :style='{"width":"100%","background":"none","height":"auto"}' @click="toDetail(item)">
	      <img :style='{"cursor":"pointer","margin":"0 0 4px","objectFit":"cover","borderRadius":"20% 40%","display":"block","width":"100%","height":"120px"}' :src="baseUrl + (item.xiaoqufengmian?item.xiaoqufengmian.split(',')[0]:'')" alt="">
	      <div :style='{"cursor":"pointer","padding":"0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#666","borderRadius":"8px","textAlign":"center","background":"none","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.xiaoqumingcheng}}</div>
	      <div :style='{"cursor":"pointer","padding":"0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#666","borderRadius":"8px","textAlign":"center","background":"none","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.xiaoquweizhi}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getHotList() {
        let autoSortUrl = "";
        autoSortUrl = "xiaoquxinxi/autoSort";
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.xiaoquweizhi != '') searchWhere.xiaoquweizhi = '%' + this.formSearch.xiaoquweizhi + '%';
