...
public class JiaofeitongzhiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiaofeitongzhiEntity jiaofeitongzhi,
		...
		if(tableName.equals("yezhu")) {
			jiaofeitongzhi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("wuyerenyuan")) {
			jiaofeitongzhi.setWuyegonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JiaofeitongzhiEntity> wrapper = new EntityWrapper<JiaofeitongzhiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jiaofeitongzhiService.selectCount(wrapper);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		if(tableName.equals("wuyerenyuan")) {
            ew.eq("wuyegonghao", (String)request.getSession().getAttribute("username"));
		}
        List<Map<String, Object>> result = jiaofeitongzhiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiaofeitongzhiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiaofeitongzhiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
