...
public class WuyerenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WuyerenyuanEntity u = wuyerenyuanService.selectOne(new EntityWrapper<WuyerenyuanEntity>().eq("wuyegonghao", username));
    ...
    public R register(@RequestBody WuyerenyuanEntity wuyerenyuan){
    	...
    	WuyerenyuanEntity u = wuyerenyuanService.selectOne(new EntityWrapper<WuyerenyuanEntity>().eq("wuyegonghao", wuyerenyuan.getWuyegonghao()));
		if(u!=null) {
